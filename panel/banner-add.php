							...
							<div class="row">
								<div class="col-sm-4">
									...
									<span class="help-text">
										...
										Images must be exactly <strong>1366x600</strong> pixels.
									</span>
									<br>
								...
								<!-- <div class="col-sm-4">
									...
									<input type="text" class="form-control"  required  name="title" id="" value="<?php if(isset($_GET['edit'])){ echo $data['title']; }?>"/>
								</div> -->
								<!-- <div class="col-sm-4">
									<label>Link <span style="color:red">*</span> </label>
									<input type="text" class="form-control" required  name="link" id="" value="<?php if(isset($_GET['edit'])){ echo $data['link']; }?>"/>
								</div> -->
							</div>
							<br>
							<div class="row">		
...
<?php 	include "include/footer.php"; ?>
	...
	$(document).ready(function() {
		$('input[type="file"]').change(function(){
			...
			loadImagePreview(this, (1366 / 600));
		});
	});
	</script>
</body>
