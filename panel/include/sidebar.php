...
<div class="sidebar collapse">
    <div class="sidebar-content">
		...
		<ul class="navigation">
			...
			<li <?php if($currentPage=='vehicle-master.php') { echo 'class="active"'; }?>><a href="vehicle_master.php"><span>Vehicle Master</span> <i class="icon-diamond"></i></a></li>
			<li <?php if($currentPage=='video-master.php') { echo 'class="active"'; }?>><a href="video-master.php"><span>Video Master</span> <i class="icon-diamond"></i></a></li>
<!-- 			
