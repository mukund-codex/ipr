<?php
	...
	$pageName = "Vehicle Master";
	$pageURL = 'vehicle_master.php';
	$addURL = 'vehicle-add.php';
	$deleteURL = 'vehicle-delete.php';
	...
	$func->checkUserPermissions('discount_coupon_view',$loggedInUserDetailsArr);
...
?>
							<tr>
								...
								<td>
									<a href="<?php echo $addURL; ?>?edit&id=<?php echo $row['id'] ?>" name="edit" class="" title="Click to edit this row" style="padding-left:20px;"><i class="icon-pencil"></i></a>
									<a class="" href="<?php echo $deleteURL; ?>?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to delete?');" title="Click to delete this row, this action cannot be undone." style="padding-left:24px;"><i class="icon-remove3"></i></a>
								</td>
							</tr>
<?php
						}
